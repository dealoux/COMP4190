...
import sys
import time
from common import AnsiColors, NodeStates, OverallStates, HeuristicMode, colorPrint, MAX_SEARCH_ITERATIONS, HEURISTIC_MODE
...
def inputhandler(filename, SolverClass):
...
inputhandler(filename, ForwardCheckingSolver)
